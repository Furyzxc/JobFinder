    ...
    return (
        <Formik initialValues={initialValues} onSubmit={handleSubmit}>
            <Form className={s.dialogsForm}>
                <Field disabled={isLoading} type="text" name='input' placeholder="Type your message here..."
                       className={s.input} autoComplete='off'/>
                <Button sx={{width: '100%'}} variant="text" endIcon={<SendIcon/>} type='submit'>
                    Send
                </Button>
            </Form>
        </Formik>
